...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F1EB] flex">
      ...
      {/* Sidebar */}
      <aside className="w-64 bg-white shadow-xl p-6 hidden md:block border-r">
      ...
      <main className="flex-1 p-6 md:p-10">
        ...
        <p className="text-gray-600 mt-1">
          Manage monasteries, users, heritage data, and more.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-10">
          ...
          <div className="bg-white p-6 rounded-xl shadow-md border flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">Heritage Entries</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <p className="text-gray-600 mt-1">
              Edit or delete existing monastery entries.
            </p>
          </Link>
          ...
          >
            ...
            <p className="text-gray-600 mt-1">
              Manage cultural stories, manuscripts & photos.
            </p>
          </Link>
